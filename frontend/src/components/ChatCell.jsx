...
const ChatCell = ({id,prompt,date,modalOpener}) => {
  return (
    <div className='flex flex-col align-baseline border-[1px] border-[#c6ac53] w-[190px] h-[120px] rounded-[8px] justify-evenly px-[10px] py-[5px] cursor-pointer' onClick={() => modalOpener({id})}>
