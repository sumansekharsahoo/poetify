...
const ChatCell = ({id,prompt,date,modalOpener}) => {
  return (
    <div className='flex flex-col align-baseline border-[1px] border-[#9d9c9c] bg-[#e5c96e] w-[190px] h-[120px] rounded-[8px] justify-evenly px-[10px] py-[5px] cursor-pointer text-stone-800 hover:bg-[#dcbc50] transition duration-300' onClick={() => modalOpener({id})}>
